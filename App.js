...
const App = () => {
  ...
  return (
    <View>
          ...
          <View style={styles.header_inner}>
            ...
            >
              ...
              <TextInput
                ...
                value={state .keyword}
                onChangeText={(value) => setState({ ...state, keyword: value })}
      ...
      <Animated.View style={[styles.content, { opacity: _content_opacity, transform: [{ translateY: this._content_translate_y }] }]}>
